...
var rootCmd = &cobra.Command{
	Use:   "konductor [COMMAND]",
	Short: "Cloud Developer Userspace",
	Long: `
Konductor is a cloud native, cloud developer userspace.

Run 'konductor --help' to learn more.
`,
